...
//!   surfaces to the SM (distinct from `DeltaError`, the kernel-to-caller error).
...
//!   [`PlanBuilder`](plan_context::PlanBuilder) for coroutine step-protocol dispatch.
//!
//! [`KernelReducer`]: crate::plans::kernel_reducers::KernelReducer
